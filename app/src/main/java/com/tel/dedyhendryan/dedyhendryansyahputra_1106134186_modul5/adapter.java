package com.tel.dedyhendryan.dedyhendryansyahputra_1106134186_modul5;

/**
 * Created by Dedy Hendryan on 25/03/2018.
 */
...
public class adapter extends RecyclerView.Adapter<adapter.holder> {
    ...
    public holder onCreateViewHolder(ViewGroup parent, int viewType) {
        //membuat view baru
        View view = LayoutInflater.from(cntx).inflate(R.layout.cardviewlist_list, parent, false);
